    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="bg-gradient-to-br from-gray-900 via-slate-900 to-black text-white py-14 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-3xl md:text-5xl font-bold mb-4 animate-fade-in-up">20 templates. Every one passes all 12 ATS checks.</h1>
          <p className="text-gray-300 text-lg max-w-2xl mx-auto animate-fade-in-up delay-100">
            Tested against real ATS parsers (Workday, Greenhouse, Lever). Pick one, customise in minutes, export to PDF.
          </p>
        </div>
      </section>
